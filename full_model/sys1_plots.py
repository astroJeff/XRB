...
# Load pickled data
sampler = pickle.load( open( INDATA("sys1_MCMC_sampler.obj"), "rb" ) )
# init_params = pickle.load( open( INDATA("sys1_pop_synth_init_conds.obj"), "rb" ) )
# HMXB = pickle.load( open( INDATA("sys1_pop_synth_HMXB.obj"), "rb" ) )
