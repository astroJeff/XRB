...
# Load pickled data
sampler = pickle.load( open( "../data/sys1_test_MCMC_sampler.obj", "rb" ) )
#init_params = pickle.load( open( "../data/sys1_test_pop_synth_init_conds.obj", "rb" ) )
#HMXB = pickle.load( open( "../data/sys1_test_pop_synth_HMXB.obj", "rb" ) )
...
plt.savefig('../figures/sys1_test_chains.pdf')
...
plt.rc('font', size=18)
plt.savefig('../figures/sys1_test_corner.pdf')
plt.rc('font', size=10)
...
plt.ylim(-74.0, -71.5)
plt.tight_layout()
plt.savefig('../figures/sys1_test_dist_birth_location.pdf')
...
plt.tight_layout()
plt.savefig('../figures/sys1_test_MCMC_pop_synth_compare.pdf')
