...
print "Loading data..."
sampler1 = pickle.load( open( INDATA("J0045_MCMC_multiburn_burn1.obj"), "rb" ) )
sampler2 = pickle.load( open( INDATA("J0045_MCMC_multiburn_burn2.obj"), "rb" ) )
sampler3 = pickle.load( open( INDATA("J0045_MCMC_multiburn_burn3.obj"), "rb" ) )
sampler4 = pickle.load( open( INDATA("J0045_MCMC_multiburn_burn4.obj"), "rb" ) )
